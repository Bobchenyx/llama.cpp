...
| CKA methodology audit: bootstrap ranking stability (200 resamples) + token-level vs chunk-averaged CKA comparison. Token-level ρ=0.60/0.64 vs chunk-averaged; top-12 overlap 58%/67%. Layer 46 (Qwen3) is a chunk-averaging artifact. Token-level PPL validated: Qwen3 7.94 vs 7.99, Qwen3.5 7.08 vs 7.11 — both methods valid, token-level slightly better. | 2026-04-07 |
