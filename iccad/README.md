...
| CKA methodology audit: bootstrap stability + token-level CKA + PPL validation | [results/cka-audit.md](results/cka-audit.md), `qwen3/cka-bootstrap.txt`, `qwen35/cka-bootstrap.txt` | 2026-04-07 |
